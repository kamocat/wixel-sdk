...
uint8 XDATA rx_global_buffer[RX_BUFFER_COUNT][MAX_PACKET_LEN];
int8 PDATA rx_buffer_index;
uint8 XDATA tx_global_buffer[TX_BUFFER_COUNT][MAX_PACKET_LEN];
...
#define rx_next_buffer() rx_global_buffer[rx_buffer_index = (rx_buffer_index ? rx_buffer_index : RX_BUFFER_COUNT) - 1 ]
#define tx_next_buffer() tx_global_buffer[tx_buffer_index = (tx_buffer_index ? tx_buffer_index : TX_BUFFER_COUNT) - 1 ]
